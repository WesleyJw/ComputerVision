...
# Renchecimento de Face com o método Cascade
...
# classificador pre treinado com o metodo cascade

# importando a biblioteca para desenhar o bolden boxes - bboxes
...
# carregando o modelo pre-treinado para reconhecer frontalface
...
# reduzindo o numero de vizinhos ou numero de fronteiras, isso melhor a acertividade do classificador
